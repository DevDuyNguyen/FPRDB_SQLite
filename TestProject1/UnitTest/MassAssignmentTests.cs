...
namespace TestProject1.UnitTest
{
    public class MassAssignmentTests
    {
        class createMassAssignment_positive_testdata:TheoryData<DiscreteFuzzySet<float>, List<VoteCrispDefinition<float>>>
        {
            ...
            {
                Add(
                    new DiscreteFuzzySet<float>(new List<float> { 3.0f, 4.0f, 5.0f, 6.0f }, new List<float> {0.2f, 0.5f, 0.9f, 1f },null,FieldType.DIST_FUZZYSET_FLOAT, -1),
                ...
                Add(
                    new DiscreteFuzzySet<float>(new List<float> { 6.0f, 5.0f, 4.0f }, new List<float> { 0.3f, 1f, 0.3f }, null, FieldType.DIST_FUZZYSET_FLOAT, -1),
                    new List<VoteCrispDefinition<float>> {
