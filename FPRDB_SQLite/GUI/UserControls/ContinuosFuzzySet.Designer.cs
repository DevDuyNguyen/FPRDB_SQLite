...
{
    partial class ContinuosFuzzySet
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            Controls.Add(txtBotRight);
            Controls.Add(txtTopRight);
            Controls.Add(txtTopLeft);
            Controls.Add(lblBotRight);
            Controls.Add(txtBotLeft);
            Controls.Add(txtNameConsFuzzy);
            Controls.Add(lblTopRight);
            Controls.Add(lblTopLeft);
            Controls.Add(lblBotLeft);
            Controls.Add(lblXCoordinates);
            Controls.Add(lblNameConsFuzzy);
            Name = "ContinuosFuzzySet";
            Size = new System.Drawing.Size(414, 228);
